...
// Input Schema
export interface IntegrationsEdrFleetdmPostInput {
	api_url: string;
...
export const IntegrationsEdrFleetdmPostInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "POST", path: "/api/integrations/edr/fleetdm" }),
) as unknown as Schema.Codec<IntegrationsEdrFleetdmPostInput>;

// Output Schema
export interface IntegrationsEdrFleetdmPostOutput {
	id: number;
	account_id: string;
	api_url: string;
...
export const IntegrationsEdrFleetdmPostOutput = /*@__PURE__*/ Schema.Struct({
	id: Schema.Number,
...
}) as unknown as Schema.Codec<IntegrationsEdrFleetdmPostOutput>;
 ...
 */
export const integrationsEdrFleetdmPost = /*@__PURE__*/ API.make(() => ({
	inputSchema: IntegrationsEdrFleetdmPostInput,
	outputSchema: IntegrationsEdrFleetdmPostOutput,
