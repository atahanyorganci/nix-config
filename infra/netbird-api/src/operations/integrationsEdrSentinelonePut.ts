...
// Input Schema
export interface IntegrationsEdrSentinelonePutInput {
...
export const IntegrationsEdrSentinelonePutInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "PUT", path: "/api/integrations/edr/sentinelone" }),
) as unknown as Schema.Codec<IntegrationsEdrSentinelonePutInput>;

// Output Schema
export interface IntegrationsEdrSentinelonePutOutput {
	id: number;
	account_id: string;
...
export const IntegrationsEdrSentinelonePutOutput = /*@__PURE__*/ Schema.Struct({
	id: Schema.Number,
...
}) as unknown as Schema.Codec<IntegrationsEdrSentinelonePutOutput>;
 ...
 */
export const integrationsEdrSentinelonePut = /*@__PURE__*/ API.make(() => ({
	inputSchema: IntegrationsEdrSentinelonePutInput,
	outputSchema: IntegrationsEdrSentinelonePutOutput,
