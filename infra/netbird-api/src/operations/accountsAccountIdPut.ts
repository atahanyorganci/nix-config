...
// Input Schema
export interface AccountsAccountIdPutInput {
	accountId: string;
	settings: {
...
export const AccountsAccountIdPutInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "PUT", path: "/api/accounts/{accountId}" }),
) as unknown as Schema.Codec<AccountsAccountIdPutInput>;

// Output Schema
export interface AccountsAccountIdPutOutput {
	id: string;
	settings: {
		peer_login_expiration_enabled: boolean;
		peer_login_expiration: number;
...
export const AccountsAccountIdPutOutput = /*@__PURE__*/ Schema.Struct({
	id: Schema.String,
	settings: Schema.Struct({
		peer_login_expiration_enabled: Schema.Boolean,
		peer_login_expiration: Schema.Number,
...
}) as unknown as Schema.Codec<AccountsAccountIdPutOutput>;
 ...
 */
export const accountsAccountIdPut = /*@__PURE__*/ API.make(() => ({
	inputSchema: AccountsAccountIdPutInput,
	outputSchema: AccountsAccountIdPutOutput,
