...
// Input Schema
export interface ReverseProxiesServicesPostInput {
	name: string;
	domain: string;
...
export const ReverseProxiesServicesPostInput = /*@__PURE__*/ Schema.Struct({
	name: Schema.String,
	...
	T.Http({ method: "POST", path: "/api/reverse-proxies/services" }),
) as unknown as Schema.Codec<ReverseProxiesServicesPostInput>;

// Output Schema
export interface ReverseProxiesServicesPostOutput {
	id: string;
	name: string;
	domain: string;
	mode?: "http" | "tcp" | "udp" | "tls";
...
export const ReverseProxiesServicesPostOutput = /*@__PURE__*/ Schema.Struct({
	id: Schema.String,
	name: Schema.String,
	domain: Schema.String,
	mode: Schema.optional(Schema.Literals(["http", "tcp", "udp", "tls"])),
	...
	private: Schema.optional(Schema.Boolean),
	access_groups: Schema.optional(Schema.Array(Schema.String)),
}) as unknown as Schema.Codec<ReverseProxiesServicesPostOutput>;
 ...
 */
export const reverseProxiesServicesPost = /*@__PURE__*/ API.make(() => ({
	inputSchema: ReverseProxiesServicesPostInput,
	outputSchema: ReverseProxiesServicesPostOutput,
