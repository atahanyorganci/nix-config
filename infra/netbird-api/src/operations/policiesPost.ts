...
// Input Schema
export interface PoliciesPostInput {
	name: string;
	description?: string;
	enabled: boolean;
...
export const PoliciesPostInput = /*@__PURE__*/ Schema.Struct({
	name: Schema.String,
...
}).pipe(T.Http({ method: "POST", path: "/api/policies" })) as unknown as Schema.Codec<PoliciesPostInput>;

// Output Schema
export interface PoliciesPostOutput {
	name: string;
	description?: string;
	enabled: boolean;
	id?: string;
...
export const PoliciesPostOutput = /*@__PURE__*/ Schema.Struct({
	name: Schema.String,
	description: Schema.optional(Schema.String),
	enabled: Schema.Boolean,
	id: Schema.optional(Schema.String),
...
}) as unknown as Schema.Codec<PoliciesPostOutput>;
 ...
 * Creates a policy
 */
export const policiesPost = /*@__PURE__*/ API.make(() => ({
	inputSchema: PoliciesPostInput,
	outputSchema: PoliciesPostOutput,
}));
