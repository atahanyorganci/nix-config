...
export const PoliciesGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
	T.Http({ method: "GET", path: "/api/policies" }),
) as unknown as Schema.Codec<PoliciesGetInput>;

// Output Schema
export type PoliciesGetOutput = ReadonlyArray<{
	name: string;
	description?: string;
	enabled: boolean;
	id?: string;
...
export const PoliciesGetOutput = /*@__PURE__*/ Schema.Array(
	Schema.Struct({
		name: Schema.String,
