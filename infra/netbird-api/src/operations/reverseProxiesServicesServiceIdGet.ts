...
// Input Schema
export interface ReverseProxiesServicesServiceIdGetInput {
	serviceId: string;
}
export const ReverseProxiesServicesServiceIdGetInput = /*@__PURE__*/ Schema.Struct({
	serviceId: Schema.String.pipe(T.PathParam()),
}).pipe(
	T.Http({ method: "GET", path: "/api/reverse-proxies/services/{serviceId}" }),
) as unknown as Schema.Codec<ReverseProxiesServicesServiceIdGetInput>;

// Output Schema
export interface ReverseProxiesServicesServiceIdGetOutput {
	id: string;
	name: string;
	domain: string;
...
export const ReverseProxiesServicesServiceIdGetOutput = /*@__PURE__*/ Schema.Struct({
	id: Schema.String,
	name: Schema.String,
...
}) as unknown as Schema.Codec<ReverseProxiesServicesServiceIdGetOutput>;
 ...
 */
export const reverseProxiesServicesServiceIdGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: ReverseProxiesServicesServiceIdGetInput,
	outputSchema: ReverseProxiesServicesServiceIdGetOutput,
