...
// Input Schema
export interface ReverseProxiesServicesGetInput {}
export const ReverseProxiesServicesGetInput = /*@__PURE__*/ Schema.Struct({}).pipe(
	T.Http({ method: "GET", path: "/api/reverse-proxies/services" }),
) as unknown as Schema.Codec<ReverseProxiesServicesGetInput>;

// Output Schema
export type ReverseProxiesServicesGetOutput = ReadonlyArray<{
	id: string;
	name: string;
	domain: string;
...
export const ReverseProxiesServicesGetOutput = /*@__PURE__*/ Schema.Array(
	Schema.Struct({
		id: Schema.String,
		name: Schema.String,
...
) as unknown as Schema.Codec<ReverseProxiesServicesGetOutput>;
 ...
 */
export const reverseProxiesServicesGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: ReverseProxiesServicesGetInput,
	outputSchema: ReverseProxiesServicesGetOutput,
