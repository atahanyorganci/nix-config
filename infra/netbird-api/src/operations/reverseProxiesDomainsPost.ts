...
// Input Schema
export interface ReverseProxiesDomainsPostInput {
	domain: string;
	target_cluster: string;
}
export const ReverseProxiesDomainsPostInput = /*@__PURE__*/ Schema.Struct({
	domain: Schema.String,
	target_cluster: Schema.String,
}).pipe(
	T.Http({ method: "POST", path: "/api/reverse-proxies/domains" }),
) as unknown as Schema.Codec<ReverseProxiesDomainsPostInput>;

// Output Schema
export interface ReverseProxiesDomainsPostOutput {
	id: string;
	name: string;
	domain: string;
...
export const ReverseProxiesDomainsPostOutput = /*@__PURE__*/ Schema.Struct({
	id: Schema.String,
	name: Schema.String,
	domain: Schema.String,
...
}) as unknown as Schema.Codec<ReverseProxiesDomainsPostOutput>;
 ...
 */
export const reverseProxiesDomainsPost = /*@__PURE__*/ API.make(() => ({
	inputSchema: ReverseProxiesDomainsPostInput,
	outputSchema: ReverseProxiesDomainsPostOutput,
