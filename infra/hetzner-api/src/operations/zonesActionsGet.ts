...
// Input Schema
export interface ZonesActionsGetInput {
...
export const ZonesActionsGetInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/zones/actions" })) as unknown as Schema.Codec<ZonesActionsGetInput>;

// Output Schema
export interface ZonesActionsGetOutput {
...
export const ZonesActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<ZonesActionsGetOutput>;
 ...
 */
export const zonesActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: ZonesActionsGetInput,
	outputSchema: ZonesActionsGetOutput,
}));
