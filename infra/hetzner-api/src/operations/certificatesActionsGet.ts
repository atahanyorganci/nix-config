...
// Input Schema
export interface CertificatesActionsGetInput {
...
export const CertificatesActionsGetInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "GET", path: "/certificates/actions" }),
) as unknown as Schema.Codec<CertificatesActionsGetInput>;

// Output Schema
export interface CertificatesActionsGetOutput {
...
export const CertificatesActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<CertificatesActionsGetOutput>;
 ...
 */
export const certificatesActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: CertificatesActionsGetInput,
	outputSchema: CertificatesActionsGetOutput,
}));
