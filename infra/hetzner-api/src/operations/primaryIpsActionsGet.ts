...
// Input Schema
export interface PrimaryIpsActionsGetInput {
...
export const PrimaryIpsActionsGetInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/primary_ips/actions" })) as unknown as Schema.Codec<PrimaryIpsActionsGetInput>;

// Output Schema
export interface PrimaryIpsActionsGetOutput {
...
export const PrimaryIpsActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<PrimaryIpsActionsGetOutput>;
 ...
 */
export const primaryIpsActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: PrimaryIpsActionsGetInput,
	outputSchema: PrimaryIpsActionsGetOutput,
}));
