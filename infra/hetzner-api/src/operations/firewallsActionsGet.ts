...
// Input Schema
export interface FirewallsActionsGetInput {
...
export const FirewallsActionsGetInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/firewalls/actions" })) as unknown as Schema.Codec<FirewallsActionsGetInput>;

// Output Schema
export interface FirewallsActionsGetOutput {
...
export const FirewallsActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<FirewallsActionsGetOutput>;
 ...
 */
export const firewallsActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: FirewallsActionsGetInput,
	outputSchema: FirewallsActionsGetOutput,
}));
