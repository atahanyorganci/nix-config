...
// Input Schema
export interface ImagesActionsGetInput {
...
export const ImagesActionsGetInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/images/actions" })) as unknown as Schema.Codec<ImagesActionsGetInput>;

// Output Schema
export interface ImagesActionsGetOutput {
...
export const ImagesActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<ImagesActionsGetOutput>;
 ...
 */
export const imagesActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: ImagesActionsGetInput,
	outputSchema: ImagesActionsGetOutput,
}));
