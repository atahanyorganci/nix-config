...
// Input Schema
export interface FloatingIpsActionsGetInput {
...
export const FloatingIpsActionsGetInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "GET", path: "/floating_ips/actions" }),
) as unknown as Schema.Codec<FloatingIpsActionsGetInput>;

// Output Schema
export interface FloatingIpsActionsGetOutput {
...
export const FloatingIpsActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<FloatingIpsActionsGetOutput>;
 ...
 */
export const floatingIpsActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: FloatingIpsActionsGetInput,
	outputSchema: FloatingIpsActionsGetOutput,
}));
