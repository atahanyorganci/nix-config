...
// Input Schema
export interface ServersIdActionsGetInput {
	id: number;
	sort?: ReadonlyArray<
		| "id"
		| "id:asc"
...
export const ServersIdActionsGetInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/servers/{id}/actions" })) as unknown as Schema.Codec<ServersIdActionsGetInput>;

// Output Schema
export interface ServersIdActionsGetOutput {
...
export const ServersIdActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<ServersIdActionsGetOutput>;
 ...
 */
export const serversIdActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: ServersIdActionsGetInput,
	outputSchema: ServersIdActionsGetOutput,
}));
