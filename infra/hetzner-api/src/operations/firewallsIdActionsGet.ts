...
// Input Schema
export interface FirewallsIdActionsGetInput {
	id: number;
	sort?: ReadonlyArray<
		| "id"
		| "id:asc"
...
export const FirewallsIdActionsGetInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "GET", path: "/firewalls/{id}/actions" }),
) as unknown as Schema.Codec<FirewallsIdActionsGetInput>;

// Output Schema
export interface FirewallsIdActionsGetOutput {
...
export const FirewallsIdActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<FirewallsIdActionsGetOutput>;
 ...
 */
export const firewallsIdActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: FirewallsIdActionsGetInput,
	outputSchema: FirewallsIdActionsGetOutput,
}));
