...
// Input Schema
export interface ServersIdGetInput {
	id: number;
}
export const ServersIdGetInput = /*@__PURE__*/ Schema.Struct({
	id: Schema.Number.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/servers/{id}" })) as unknown as Schema.Codec<ServersIdGetInput>;

// Output Schema
export interface ServersIdGetOutput {
	server?: {
		id: number;
		name: string;
		status:
...
export const ServersIdGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<ServersIdGetOutput>;
 ...
 */
export const serversIdGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: ServersIdGetInput,
	outputSchema: ServersIdGetOutput,
}));
