...
// Input Schema
export interface LoadBalancersActionsGetInput {
...
export const LoadBalancersActionsGetInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "GET", path: "/load_balancers/actions" }),
) as unknown as Schema.Codec<LoadBalancersActionsGetInput>;

// Output Schema
export interface LoadBalancersActionsGetOutput {
...
export const LoadBalancersActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<LoadBalancersActionsGetOutput>;
 ...
 */
export const loadBalancersActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: LoadBalancersActionsGetInput,
	outputSchema: LoadBalancersActionsGetOutput,
}));
