...
// Input Schema
export interface LoadBalancersIdGetInput {
	id: number;
}
export const LoadBalancersIdGetInput = /*@__PURE__*/ Schema.Struct({
	id: Schema.Number.pipe(T.PathParam()),
}).pipe(T.Http({ method: "GET", path: "/load_balancers/{id}" })) as unknown as Schema.Codec<LoadBalancersIdGetInput>;

// Output Schema
export interface LoadBalancersIdGetOutput {
	load_balancer: {
		id: number;
		name: string;
		public_net: {
...
export const LoadBalancersIdGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<LoadBalancersIdGetOutput>;
 ...
 */
export const loadBalancersIdGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: LoadBalancersIdGetInput,
	outputSchema: LoadBalancersIdGetOutput,
}));
