...
// Input Schema
export interface FloatingIpsIdActionsGetInput {
	id: number;
	sort?: ReadonlyArray<
		| "id"
		| "id:asc"
...
export const FloatingIpsIdActionsGetInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "GET", path: "/floating_ips/{id}/actions" }),
) as unknown as Schema.Codec<FloatingIpsIdActionsGetInput>;

// Output Schema
export interface FloatingIpsIdActionsGetOutput {
...
export const FloatingIpsIdActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<FloatingIpsIdActionsGetOutput>;
 ...
 */
export const floatingIpsIdActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: FloatingIpsIdActionsGetInput,
	outputSchema: FloatingIpsIdActionsGetOutput,
}));
