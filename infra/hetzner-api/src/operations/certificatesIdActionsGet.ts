...
// Input Schema
export interface CertificatesIdActionsGetInput {
	id: number;
	sort?: ReadonlyArray<
		| "id"
		| "id:asc"
...
export const CertificatesIdActionsGetInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "GET", path: "/certificates/{id}/actions" }),
) as unknown as Schema.Codec<CertificatesIdActionsGetInput>;

// Output Schema
export interface CertificatesIdActionsGetOutput {
...
export const CertificatesIdActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<CertificatesIdActionsGetOutput>;
 ...
 */
export const certificatesIdActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: CertificatesIdActionsGetInput,
	outputSchema: CertificatesIdActionsGetOutput,
}));
