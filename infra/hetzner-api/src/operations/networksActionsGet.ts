...
// Input Schema
export interface NetworksActionsGetInput {
...
export const NetworksActionsGetInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/networks/actions" })) as unknown as Schema.Codec<NetworksActionsGetInput>;

// Output Schema
export interface NetworksActionsGetOutput {
...
export const NetworksActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<NetworksActionsGetOutput>;
 ...
 */
export const networksActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: NetworksActionsGetInput,
	outputSchema: NetworksActionsGetOutput,
}));
