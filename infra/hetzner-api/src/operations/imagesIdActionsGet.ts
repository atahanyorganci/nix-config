...
// Input Schema
export interface ImagesIdActionsGetInput {
	id: number;
	sort?: ReadonlyArray<
		| "id"
		| "id:asc"
...
export const ImagesIdActionsGetInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/images/{id}/actions" })) as unknown as Schema.Codec<ImagesIdActionsGetInput>;

// Output Schema
export interface ImagesIdActionsGetOutput {
...
export const ImagesIdActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<ImagesIdActionsGetOutput>;
 ...
 */
export const imagesIdActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: ImagesIdActionsGetInput,
	outputSchema: ImagesIdActionsGetOutput,
}));
