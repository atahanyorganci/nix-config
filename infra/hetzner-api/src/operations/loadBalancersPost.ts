...
// Input Schema
export interface LoadBalancersPostInput {
	name: string;
...
export const LoadBalancersPostInput = /*@__PURE__*/ Schema.Struct({
	name: Schema.String,
...
}).pipe(T.Http({ method: "POST", path: "/load_balancers" })) as unknown as Schema.Codec<LoadBalancersPostInput>;

// Output Schema
export interface LoadBalancersPostOutput {
	load_balancer: {
		id: number;
		name: string;
		public_net: {
...
export const LoadBalancersPostOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<LoadBalancersPostOutput>;
 ...
 */
export const loadBalancersPost = /*@__PURE__*/ API.make(() => ({
	inputSchema: LoadBalancersPostInput,
	outputSchema: LoadBalancersPostOutput,
}));
