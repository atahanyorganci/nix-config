...
// Input Schema
export interface LoadBalancersIdActionsGetInput {
	id: number;
	sort?: ReadonlyArray<
		| "id"
		| "id:asc"
...
export const LoadBalancersIdActionsGetInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "GET", path: "/load_balancers/{id}/actions" }),
) as unknown as Schema.Codec<LoadBalancersIdActionsGetInput>;

// Output Schema
export interface LoadBalancersIdActionsGetOutput {
...
export const LoadBalancersIdActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<LoadBalancersIdActionsGetOutput>;
 ...
 */
export const loadBalancersIdActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: LoadBalancersIdActionsGetInput,
	outputSchema: LoadBalancersIdActionsGetOutput,
}));
