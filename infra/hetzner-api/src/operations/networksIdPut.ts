...
// Input Schema
export interface NetworksIdPutInput {
	id: number;
	name?: string;
	labels?: Record<string, string>;
	expose_routes_to_vswitch?: boolean;
}
export const NetworksIdPutInput = /*@__PURE__*/ Schema.Struct({
	id: Schema.Number.pipe(T.PathParam()),
	name: Schema.optional(Schema.String),
	labels: Schema.optional(Schema.Record(Schema.String, Schema.String)),
	expose_routes_to_vswitch: Schema.optional(Schema.Boolean),
}).pipe(T.Http({ method: "PUT", path: "/networks/{id}" })) as unknown as Schema.Codec<NetworksIdPutInput>;

// Output Schema
export interface NetworksIdPutOutput {
	network?: {
		id: number;
		name: string;
		ip_range: string;
...
export const NetworksIdPutOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<NetworksIdPutOutput>;
 ...
 */
export const networksIdPut = /*@__PURE__*/ API.make(() => ({
	inputSchema: NetworksIdPutInput,
	outputSchema: NetworksIdPutOutput,
}));
