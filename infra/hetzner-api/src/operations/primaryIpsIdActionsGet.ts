...
// Input Schema
export interface PrimaryIpsIdActionsGetInput {
	id: number;
	sort?: ReadonlyArray<
		| "id"
		| "id:asc"
...
export const PrimaryIpsIdActionsGetInput = /*@__PURE__*/ Schema.Struct({
	...
	T.Http({ method: "GET", path: "/primary_ips/{id}/actions" }),
) as unknown as Schema.Codec<PrimaryIpsIdActionsGetInput>;

// Output Schema
export interface PrimaryIpsIdActionsGetOutput {
...
export const PrimaryIpsIdActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<PrimaryIpsIdActionsGetOutput>;
 ...
 */
export const primaryIpsIdActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: PrimaryIpsIdActionsGetInput,
	outputSchema: PrimaryIpsIdActionsGetOutput,
}));
