...
// Input Schema
export interface VolumesActionsGetInput {
...
export const VolumesActionsGetInput = /*@__PURE__*/ Schema.Struct({
...
}).pipe(T.Http({ method: "GET", path: "/volumes/actions" })) as unknown as Schema.Codec<VolumesActionsGetInput>;

// Output Schema
export interface VolumesActionsGetOutput {
...
export const VolumesActionsGetOutput = /*@__PURE__*/ Schema.Struct({
...
}) as unknown as Schema.Codec<VolumesActionsGetOutput>;
 ...
 */
export const volumesActionsGet = /*@__PURE__*/ API.make(() => ({
	inputSchema: VolumesActionsGetInput,
	outputSchema: VolumesActionsGetOutput,
}));
